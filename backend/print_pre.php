...
<title> บิลใบเสร็จชำระเงิน/ค่ามัดจำสินค้า   </title>
</head>  
<style>
@font-face {
...
<tr> 
 <td align="center"     >   
	...
	<b>
		 ...
		 บิลใบเสร็จชำระเงิน/ค่ามัดจำสินค้า
...
<tr> 
 <td width="80%" align="right"     >   
	...
	<font size="3px" style=" font-size: 18px; ">  
		...
		echo number_format(0+$totalprice1)   ; ?> บาท
		<div style="margin-top: 5px; ">  </div>
		โค้ตส่วนลด <?php 
		...
		echo number_format(0+$discountprice)   ;?> บาท
		<div style="margin-top: 5px; ">  </div>
		ค่าขนส่ง 100 บาท
		<div style="margin-top: 5px; ">  </div>
		ยอดชำระทั้งหมด <?php echo number_format(0+$totalprice1+100-$discountprice) ;?> บาท
		<div style="margin-top: 5px; ">  </div> 
		ยอดมัดจำ 50 $ ชำระ <?php echo number_format(0+ ($totalprice1+100-$discountprice) / 2 )   ;?> บาท
		<div style="margin-top: 5px; ">  </div>
