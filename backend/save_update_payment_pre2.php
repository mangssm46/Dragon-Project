...
include('../database.php'); 
			...
			if(empty($check_image11)){
				...
				{
					 $update_img11  =  ",slip2 = '".$check_image11."'" ;
				} 
			}


				$strSQL = " Update list_order Set 
				 bank2 = '".$_POST["banksave"]."', 
				 update_slip12 = '".date('d-m-Y')."', 
				 update_slip22 = '".date('H:i')."' " . $update_img11 ;
				$strSQL .=" WHERE bill_no = '". $_POST["billsave"]."' "; 

				$objQuery = mysqli_query($objCon, $strSQL); 

				 
				 echo("<script>window.location = 'checkpaymentpre.php';</script>");
