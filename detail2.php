...
include('header.php');
	...
	$i = 1;  
	$sql2 = "SELECT * FROM product_pre where pk = '".$_GET["product"]."'    "; 
	...
	{  
		...
		$checkstatus2 = "";
		$pksave = "";
		$sql4 = "SELECT * FROM product_list_pre  where bill_no = '".$objResult2["bill_no"]."' order by pk asc limit 1   "; 
		$query4 = mysqli_query($objCon,$sql4);
		while($objResult4 = mysqli_fetch_array($query4))
		{  
		...
		$loopbtn = 0;
		$sql4 = "SELECT * FROM product_list_pre  where bill_no = '".$objResult2["bill_no"]."' order by pk asc     "; 
		$query4 = mysqli_query($objCon,$sql4);
		while($objResult4 = mysqli_fetch_array($query4))
		{ 
			$loopbtn++;
    ...
    <section class="container py-5" style="background-color: #FFF; ">
			 ...
			 <div class="row">
                ...
                <div class="col-lg-8 mt-5">
                    <div class="card"  style="border: 0px solid #000;  ">
                            ...
                            <font style="font-size: 25px;"> 
                             ...
                             <table width="100%" border="0">
                             	<tr>
									...
									$caltime = 0;
									$caltime2 = 0;
									$sql4 = "SELECT * FROM product_pre where bill_no = '".$bill_no."'  ";
									$query4 = mysqli_query($objCon,$sql4);
									while($objResult4 = mysqli_fetch_array($query4))
									{
										...
										if($caltime < 0){ 
											  echo("<script>alert('  ยังไม่ถึงเวลาเปิดให้พรีออเดอร์ ')</script>");
										...
										if($caltime2 > 0){ 
											...
											$objQuery = mysqli_query($objCon, $strSQL); 
											  ...
											  echo("<script>alert(' สินค้าชิ้นนี้หมดเวลาพรีออเดอร์ ')</script>");
											  echo("<script>window.location = 'index.php';</script>");
										}
                        	...
                        	<div class=" col-lg-12">
                             <font style="font-size: 20px; "> ราคา :  </font> <font style="font-size: 20px; " color="#AD2323" id="txtprice"> 
                                 ...
                                 <?php if(!empty($_SESSION["UserID2"])){ ?>
                                    ...
                                    <div class="col-lg-12">  
										...
										<img src="images/aa1.png" style=" width: 18px;"  >   </button>
									  	...
									  	&nbsp; &nbsp; 
										<font  id="showtxttotal" style=" font-size: 18px; display: none;" color="#808080"  >   
                                    ...
                                    <div class="col col-md-12"> 
                						<button type="button" class="btn btn-sm  " style="background-color: #FFF; border: 1px solid #FF6633; margin-bottom: 10px; margin-top: 40px;   margin-right: 0px;  border-radius: 5px; width: 180px; height: 45px;     "   onClick="Saveordercart()"    > <font color="#FF6633" style="font-size: 17px; "> <img src="images/cart.png"  style="width: 17px; " >  หยิบลงตะกร้า  </font> </button>
               							...
               							<a href="index.php"> 
                						<button type="button" class="btn btn-sm  " style="background-color: #FF6633; border: 1px solid #FF6633; margin-bottom: 10px; margin-top: 40px;  margin-right: 0px;   border-radius: 5px; width: 180px; height: 45px;   "    > <font color="#FFF" style="font-size: 17px; ">  ซื้อสินค้า  </font> </button>  
               							</a>
                                    </div>
                                    </div>
                                    ...
                                    <script>
									 function Saveordercart() { 
									   ...
									   var int1 =	document.getElementById("product-quanity").value;
										 ...
										 $.ajax({
										 type: "POST",
										 url: "save_cart_pre.php?savepk="+savepk+"&total="+gettotal,
										 data: {data1:int1},
										 success: function(result) {
											...
											if(check_number == 0){
												...
												alert(' ยังไม่ถึงเวลาเปิดให้พรีออเดอร์ ');	  

											}else if(check_number == 2){  
												alert(' หมดเวลาพรีออเดอร์ ');	  
											}
		...
		{      
			...
			$.ajax({
				type: "GET",
				url: "loadcomment2.php?productment="+productgetdata,
				success: function(result) {
			...
			$.ajax({
				type: "GET",
				url: "loadcomment2_top.php?productment="+productgetdata,
				success: function(result) {
	  ...
	  @media only screen and (max-width: 767px){ 
       ...
       <div class=" col-lg-12  "  style="margin-top: 20px; " ></div>
		   ...
		   <?php 
			...
			$sql2 = "SELECT a.*, b.price, b.img FROM product_pre a  Inner Join product_list_pre b On a.bill_no = b.bill_no order by a.pk desc limit 4   "; 
			$query2 = mysqli_query($objCon,$sql2);
			while($objResult2 = mysqli_fetch_array($query2))
			{  
                   ...
                   <div align="center"> 
					 ...
					 <h6>
						...
						<font color="#000" style=" font-size: 12px; "> 
						  ...
						  <font color="#FF6633" style=" font-size: 13px; " > ฿ <?php 
				
							if(empty($objResult2["price"])){
								echo number_format(0, '2', '.', ','); 
							}else{
								echo number_format(0+$objResult2["price"], '2', '.', ','); 
							}
                     ...
                     <table width="100%">
                     	<tr>
                     		<td width="40%">  
                     		<img src="images/star.png" style=" width: 12px;" >
                     		<img src="images/star.png" style=" width: 12px;" >
                     		<img src="images/star.png" style=" width: 12px;" >
                     		<img src="images/star.png" style=" width: 12px;" >
                     		    <font color="#000" style=" font-size: 10px; " > (329) </font> 
                     		</td>
                     		<td align="right" >  
