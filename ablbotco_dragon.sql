...
--
-- Host: localhost
-- Generation Time: Nov 07, 2023 at 03:40 AM
...
--
-- Database: `ablbotco_dragon`
--

-- --------------------------------------------------------

--
-- Table structure for table `aumpher`
--

CREATE TABLE `aumpher` (
...
--
-- Dumping data for table `aumpher`
--

INSERT INTO `aumpher` (`AMPHUR_ID`, `AMPHUR_CODE`, `AMPHUR_NAME`, `GEO_ID`, `PROVINCE_ID`) VALUES
...
INSERT INTO `bank` (`pk`, `name`) VALUES
(1, 'ธนาคารกรุงเทพ'),
(2, 'ธนาคารกสิกรไทย'),
...
INSERT INTO `bank2` (`pk`, `bank`, `name`, `bookbank`) VALUES
(3, '1', 'บุญรีด มารวย', 2147483647),
(4, '1', 'นาย สวัสดี แล้วนะ', 2147483647);

-- --------------------------------------------------------

--
-- Table structure for table `codenumber`
--
...
--
-- Dumping data for table `codenumber`
--

INSERT INTO `codenumber` (`pk`, `codeno`, `price`, `status`) VALUES
(1, '1', 100, 'ใช้งานแล้ว'),
(2, '1234', 100, 'ใช้งานแล้ว'),
(5, '2222', 100, 'ยังไม่ได้ใช้งาน');
...
INSERT INTO `country` (`PROVINCE_ID`, `PROVINCE_CODE`, `PROVINCE_NAME`, `GEO_ID`) VALUES
...
INSERT INTO `customer` (`pk`, `name`, `address`, `address1`, `address2`, `address3`, `address4`, `telphone`, `line`, `username`, `password`, `status`, `img`) VALUES
(1, 'นาย บรรจง ลงนอน', '99/85642', '1', '3', '100302', '10530', '0876733753', 'kkk', 'test', '1234', 'M', '');

-- --------------------------------------------------------

--
-- Table structure for table `drophight`
--

CREATE TABLE `drophight` (
  `pk` int(11) NOT NULL,
  `orderdarta` text NOT NULL,
  `name` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `drophight`
--

INSERT INTO `drophight` (`pk`, `orderdarta`, `name`) VALUES
(1, 'ASC', 'เก่าไปใหม่'),
(2, 'DESC', 'ใหม่ไปเก่า');
...
--
-- Table structure for table `drop_statusproduct`
--

CREATE TABLE `drop_statusproduct` (
  `pk` int(11) NOT NULL,
  `name` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `drop_statusproduct`
--

INSERT INTO `drop_statusproduct` (`pk`, `name`) VALUES
(1, 'พร้อมจำหน่าย'),
(2, 'ไม่พร้อมจำหน่าย');
...
--
-- Table structure for table `drop_statusproduct2`
--

CREATE TABLE `drop_statusproduct2` (
  `pk` int(11) NOT NULL,
  `name` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `drop_statusproduct2`
--

INSERT INTO `drop_statusproduct2` (`pk`, `name`) VALUES
(1, 'ราคาปกติ'),
(2, 'ลดราคา');
...
CREATE TABLE `list_order` (
  ...
  `status` text NOT NULL,
  `bank` text NOT NULL,
  `update_slip1` text NOT NULL,
  `update_slip2` text NOT NULL,
  `slip` text NOT NULL,
  `noteaddress` text NOT NULL,
  `status_paymet` text NOT NULL,
  `status_send` text NOT NULL,
  `status_product` text NOT NULL,
  `discount` text NOT NULL,
  `discountprice` text NOT NULL,
  `sendprice` text NOT NULL,
  `memberpayment` text NOT NULL,
  `statusback` text NOT NULL,
  `pasy_onoff` text NOT NULL,
  `pasy_bill` text NOT NULL,
  `pasy_createby` text NOT NULL,
  `pasy_createdate` text NOT NULL,
  `pasy_createdate2` text NOT NULL,
  `pasy_createtime` text NOT NULL,
  `pasy_note` text NOT NULL,
  `pasy_status` text NOT NULL,
  `typedatasend` text NOT NULL,
  `star` text NOT NULL,
  `reviewnote` text NOT NULL,
  `c_date` text NOT NULL,
  `c_time` text NOT NULL,
  `numbersend` text NOT NULL,
  `slip2` text NOT NULL,
  `bank2` text NOT NULL,
  `update_slip12` text NOT NULL,
  `update_slip22` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `list_order` (`pk`, `menu_id`, `total`, `price`, `create_date`, `create_date2`, `create_time`, `create_by`, `bill_no`, `status`, `bank`, `update_slip1`, `update_slip2`, `slip`, `noteaddress`, `status_paymet`, `status_send`, `status_product`, `discount`, `discountprice`, `sendprice`, `memberpayment`, `statusback`, `pasy_onoff`, `pasy_bill`, `pasy_createby`, `pasy_createdate`, `pasy_createdate2`, `pasy_createtime`, `pasy_note`, `pasy_status`, `typedatasend`, `star`, `reviewnote`, `c_date`, `c_time`, `numbersend`, `slip2`, `bank2`, `update_slip12`, `update_slip22`) VALUES
(1, '3', '2', '100', '02-11-2023', '2023-11-02', '22:25', '1', 'BJ02112023-1', '', '4', '02-11-2023', '22:26', 'Slip2883jpg', 'Productpre', '1', 'รอรับสินค้า', 'Productpre', '', '', '100', 'หมดเวลา', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(2, '4', '5', '300', '02-11-2023', '2023-11-02', '22:25', '1', 'BJ02112023-1', '', '4', '02-11-2023', '22:26', 'Slip2883jpg', 'Productpre', '1', 'รอรับสินค้า', 'Productpre', '', '', '100', 'หมดเวลา', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(4, '3', '3', '100', '03-11-2023', '2023-11-03', '22:51', '1', 'BJ03112023-2', '', '4', '03-11-2023', '22:51', 'Slip5216jpg', 'Productpre', '1', 'รับสินค้าเรียบร้อยแล้ว', 'Productpre', '', '', '100', '', '', '', '', '', '', '', '', '', '', '1', '', '', '', '', '', 'Slip7631jpg', '4', '03-11-2023', '23:48'),
(5, '3', '6', '100', '03-11-2023', '2023-11-03', '23:55', '1', 'BJ03112023-3', '', '4', '03-11-2023', '23:56', 'Slip4452jpg', 'Productpre', '1', 'รับสินค้าเรียบร้อยแล้ว', 'Productpre', '', '', '100', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'Slip4403jpg', '4', '03-11-2023', '23:56'),
(17, '1', '4', '100', '07-11-2023', '2023-11-07', '10:20', '1', 'B07112023-1', '', '4', '07-11-2023', '10:27', 'Slip6942jpg', 'Product', '1', 'รับสินค้าเรียบร้อยแล้ว', 'Product', '', '', '100', '', '', '', '', '', '', '', '', '', '', '1', '', '', '', '', '', '', '', '', ''),
(18, '2', '5', '135', '07-11-2023', '2023-11-07', '10:20', '1', 'B07112023-1', '', '4', '07-11-2023', '10:27', 'Slip6942jpg', 'Product', '1', 'รับสินค้าเรียบร้อยแล้ว', 'Product', '', '', '100', '', '', '', '', '', '', '', '', '', '', '1', '', '', '', '', '', '', '', '', ''),
(19, '3', '3', '95', '07-11-2023', '2023-11-07', '10:25', '1', 'BJ07112023-4', '', '4', '07-11-2023', '10:27', 'Slip6604jpg', 'Productpre', '1', 'รอรับสินค้า', 'Productpre', '', '', '100', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `list_order_fav`
--

CREATE TABLE `list_order_fav` (
  `pk` int(11) NOT NULL,
  `menu_id` text NOT NULL,
  `create_by` text NOT NULL,
...
--
-- Dumping data for table `list_order_fav`
--

INSERT INTO `list_order_fav` (`pk`, `menu_id`, `create_by`, `typedata`) VALUES
(1, '2', '1', 'preorder'),
(2, '2', '1', 'product'),
(3, '3', '1', 'preorder');
...
INSERT INTO `member_all` (`pk`, `name`, `username`, `password`, `status`, `address`, `address1`, `address2`, `address3`, `address4`, `telphone`, `line`) VALUES
(1, 'admin', 'admin', '1234', 'A', '', '', '', '', '', '', ''),
(2, 'นาย พล เอก', 'staff', '1234', 'ST', '22', '2', '53', '110201', '10560', '0876373637', 'Line');
...
INSERT INTO `product` (`pk`, `bill_no`, `name`, `detail`, `typedata`, `typedata2`) VALUES
(1, '005', 'TEST1', '<div>TEST1</div>\r\n', '1', 'ตัว'),
(2, '006', 'TEST123', '<div>TEST1</div>\r\n', '1', 'ตัว');
...
INSERT INTO `product_img` (`pk`, `img`, `bill_no`) VALUES
(4, 'FREGrimg487img734020.png', 'P003'),
(5, 'FREGrimg136img476173.png', 'P004'),
(6, 'Grimg61977img503700.png', 'P005'),
(7, 'FREGrimg206img857462.png', '005'),
(8, 'FREGrimg286img163975.png', '006');
...
INSERT INTO `product_list` (`pk`, `bill_no`, `color`, `size`, `price`, `total`, `img`, `create_by`, `discount`, `statusproduct`, `statusproduct2`) VALUES
(1, '006', '1', '1', '100', '94', 'Grimg3246672img340666.png', '1', '', 'พร้อมจำหน่าย', 'ราคาปกติ'),
(2, '006', '1', '1', '150', '196', 'Grimg3216413img832566.png', '1', '10', 'พร้อมจำหน่าย', 'ลดราคา');

-- --------------------------------------------------------

--
-- Table structure for table `product_list_pre`
--

CREATE TABLE `product_list_pre` (
  `pk` int(11) NOT NULL,
  `bill_no` text NOT NULL,
  `color` text NOT NULL,
  `size` text NOT NULL,
...
--
-- Dumping data for table `product_list_pre`
--

INSERT INTO `product_list_pre` (`pk`, `bill_no`, `color`, `size`, `price`, `total`, `img`, `create_by`, `discount`, `statusproduct`, `statusproduct2`) VALUES
(3, 'P004', '1', '1', '100', '', 'Grimg3609068img150603.png', '1', '5', 'พร้อมจำหน่าย', 'ลดราคา'),
(4, 'P005', '1', '1', '300', '', 'Grimg5504100img675879.png', '1', '', 'พร้อมจำหน่าย', '');

-- --------------------------------------------------------

--
-- Table structure for table `product_pre`
--

CREATE TABLE `product_pre` (
  `pk` int(11) NOT NULL,
  `bill_no` text NOT NULL,
  `name` text NOT NULL,
  `detail` text NOT NULL,
...
--
-- Dumping data for table `product_pre`
--

INSERT INTO `product_pre` (`pk`, `bill_no`, `name`, `detail`, `typedata`, `typedata2`, `startdate`, `timeend`, `enddate`, `timeend2`, `newstart`, `newend`, `onoff`) VALUES
(1, 'P003', 'TEST', '<div>TEST</div>\r\n', '1', 'ตัว', '02/11/2023', '22:01', '30/11/2023', '23:01', '2023-11-02', '2023-11-30', ''),
(2, 'P004', 'TEST', '<div>TEST</div>\r\n', '1', 'ตัว', '02/11/2023', '22:02', '30/11/2023', '23:02', '2023-11-02', '2023-11-30', ''),
(3, 'P005', 'TEST77', '<div>TEST77</div>\r\n', '1', 'ตัว', '02/11/2023', '22:18', '30/11/2023', '23:17', '2023-11-02', '2023-11-30', '');
...
INSERT INTO `rude` (`pk`, `rude_name`) VALUES
(1, 'เย็ด'),
(2, 'ควาย'),
(3, 'กระบือ'),
(4, 'แม่มึง');
...
--
-- Table structure for table `run_billcomeback`
--

CREATE TABLE `run_billcomeback` (
  `pk` int(11) NOT NULL,
  `bill_no` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `run_billcomebackpre`
--

CREATE TABLE `run_billcomebackpre` (
  `pk` int(11) NOT NULL,
  `bill_no` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `run_bill_pre`
--

CREATE TABLE `run_bill_pre` (
  `pk` int(11) NOT NULL,
  `bill_no` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `run_bill_pre`
--

INSERT INTO `run_bill_pre` (`pk`, `bill_no`) VALUES
(1, 'BJ02112023-1'),
(2, 'BJ03112023-2'),
(3, 'BJ03112023-3'),
(4, 'BJ07112023-4');
...
--
-- Table structure for table `run_productpre`
--

CREATE TABLE `run_productpre` (
  `pk` int(11) NOT NULL,
  `bill_no` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `run_productpre`
--

INSERT INTO `run_productpre` (`pk`, `bill_no`) VALUES
(7, '001'),
(8, '002'),
(9, 'P003'),
(10, 'P004'),
...
INSERT INTO `tumbon` (`DISTRICT_ID`, `DISTRICT_CODE`, `DISTRICT_NAME`, `AMPHUR_ID`, `PROVINCE_ID`, `GEO_ID`) VALUES
...
INSERT INTO `typecolor` (`pk`, `name`) VALUES
(1, 'RED'),
(2, 'GREEN');
...
INSERT INTO `typeproduct` (`pk`, `name`) VALUES
(1, 'เสื้อ'),
(2, 'รองเท้า');
...
--
-- Table structure for table `typesend`
--

CREATE TABLE `typesend` (
  `pk` int(11) NOT NULL,
  `name` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

--
-- Dumping data for table `typesend`
--

INSERT INTO `typesend` (`pk`, `name`) VALUES
(1, 'Kerry'),
(2, 'Panda'),
(3, 'Flash');
...
--
-- Table structure for table `typesize`
--
...
--
-- Dumping data for table `typesize`
--

INSERT INTO `typesize` (`pk`, `name`) VALUES
(1, 'S'),
(2, 'M'),
(3, 'L'),
(4, 'XL');
...
--
-- Table structure for table `update_real_time`
--

CREATE TABLE `update_real_time` (
  `pk` int(11) NOT NULL,
  `create_date` text NOT NULL,
  `major` text NOT NULL,
  `create_date2` text NOT NULL,
...
--
-- Dumping data for table `update_real_time`
--

INSERT INTO `update_real_time` (`pk`, `create_date`, `major`, `create_date2`, `create_time`, `create_by`, `status`, `contact`, `bill_no`) VALUES
(1, '001', '001', '2023-08-28', '13:56', '1', ' เพิ่มสินค้า ', '001', '001'),
(2, '001', '001', '2023-08-28', '14:25', '1', ' อัพเดต ', '001', '001'),
(3, '001', '001', '2023-08-28', '14:25', '1', ' อัพเดต ', '001', '001'),
(4, '001', '001', '2023-08-28', '14:26', '1', ' อัพเดต ', '001', '001'),
(5, '001', '001', '2023-08-28', '14:26', '1', ' อัพเดต ', '001', '001'),
(6, '001', '001', '2023-08-28', '14:26', '1', ' อัพเดต ', '001', '001'),
(7, '001', '001', '2023-08-28', '14:28', '1', ' อัพเดต ', '001', '001'),
(8, '002', '002', '2023-08-30', '14:41', '1', ' เพิ่มสินค้า ', '002', '002'),
(9, '001', '001', '2023-08-30', '14:42', '1', ' อัพเดต ', '001', '001'),
(10, '13', '13', '2023-08-30', '15:41', '1', ' เพิ่มจำนวน 110 ', '001', '001'),
(11, '13', '13', '2023-08-30', '15:41', '1', ' เพิ่มจำนวน 130 ', '001', '001'),
(12, '13', '13', '2023-08-30', '15:42', '1', ' เพิ่มจำนวน 180 ', '001', '001'),
(13, '13', '13', '2023-08-30', '18:02', '1', ' เพิ่มจำนวน 60 ', '001', '001'),
(14, '13', '13', '2023-08-30', '18:02', '1', ' เพิ่มจำนวน 70 ', '001', '001'),
(15, '001', '001', '2023-09-08', '09:14', '1', ' เพิ่มสินค้าพรีออเดอร์ ', '001', '001'),
(16, '001', '001', '2023-09-08', '09:30', '1', ' อัพเดต ', '001', '001'),
(17, '001', '001', '2023-09-08', '09:30', '1', ' อัพเดต ', '001', '001'),
(18, '001', '001', '2023-09-08', '09:30', '1', ' อัพเดต ', '001', '001'),
(19, '002', '002', '2023-09-13', '10:00', '1', ' เพิ่มสินค้าพรีออเดอร์ ', '002', '002'),
(20, '003', '003', '2023-09-13', '10:03', '1', ' เพิ่มสินค้าพรีออเดอร์ ', '003', '003'),
(21, '004', '004', '2023-09-13', '10:04', '1', ' เพิ่มสินค้าพรีออเดอร์ ', '004', '004'),
(22, '004', '004', '2023-09-13', '10:08', '1', ' อัพเดต ', '004', '004'),
(23, '004', '004', '2023-09-13', '10:08', '1', ' อัพเดต ', '004', '004'),
(24, '002', '002', '2023-09-21', '17:29', '1', ' อัพเดต ', '002', '002'),
(25, '002', '002', '2023-09-21', '17:33', '1', ' อัพเดต ', '002', '002'),
(26, '002', '002', '2023-09-21', '17:33', '1', ' อัพเดต ', '002', '002'),
(27, '002', '002', '2023-09-21', '17:34', '1', ' อัพเดต ', '002', '002'),
(28, '002', '002', '2023-09-21', '17:35', '1', ' อัพเดต ', '002', '002'),
(29, '002', '002', '2023-09-21', '18:27', '1', ' อัพเดต ', '002', '002'),
(30, '004', '004', '2023-09-22', '15:21', '1', ' อัพเดต ', '004', '004'),
(31, '004', '004', '2023-10-12', '16:49', '1', ' อัพเดต ', '004', '004'),
(32, '004', '004', '2023-10-12', '16:50', '1', ' อัพเดต ', '004', '004'),
(33, '004', '004', '2023-10-12', '16:50', '1', ' อัพเดต ', '004', '004'),
(34, '004', '004', '2023-10-12', '16:53', '1', ' อัพเดต ', '004', '004'),
(35, '005', '005', '2023-11-02', '20:59', '1', ' เพิ่มสินค้าพรีออเดอร์ ', '005', '005'),
(36, '006', '006', '2023-11-02', '21:07', '1', ' เพิ่มสินค้าพรีออเดอร์ ', '006', '006'),
(37, '001', '001', '2023-11-02', '21:12', '1', ' เพิ่มสินค้าพรีออเดอร์ ', '001', '001'),
(38, '001', '001', '2023-11-02', '21:50', '1', ' อัพเดต ', '001', '001'),
(39, '002', '002', '2023-11-02', '21:55', '1', ' เพิ่มสินค้าพรีออเดอร์ ', '002', '002'),
(40, 'P003', 'P003', '2023-11-02', '22:01', '1', ' เพิ่มสินค้าพรีออเดอร์ ', 'P003', 'P003'),
(41, 'P004', 'P004', '2023-11-02', '22:02', '1', ' เพิ่มสินค้าพรีออเดอร์ ', 'P004', 'P004'),
(42, 'P004', 'P004', '2023-11-02', '22:03', '1', ' อัพเดต ', 'P004', 'P004'),
(43, 'P004', 'P004', '2023-11-02', '22:05', '1', ' อัพเดต ', 'P004', 'P004'),
(44, '005', '005', '2023-11-02', '22:09', '1', ' เพิ่มสินค้า ', '005', '005'),
(45, '006', '006', '2023-11-02', '22:10', '1', ' เพิ่มสินค้า ', '006', '006'),
(46, '006', '006', '2023-11-02', '22:10', '1', ' อัพเดต ', '006', '006'),
(47, 'P003', 'P003', '2023-11-02', '22:10', '1', ' อัพเดต ', 'P003', 'P003'),
(48, 'P004', 'P004', '2023-11-02', '22:11', '1', ' อัพเดต ', 'P004', 'P004'),
(49, 'P005', 'P005', '2023-11-02', '22:18', '1', ' เพิ่มสินค้าพรีออเดอร์ ', 'P005', 'P005'),
(50, 'P005', 'P005', '2023-11-02', '22:18', '1', ' อัพเดต ', 'P005', 'P005'),
(51, '005', '005', '2023-11-07', '09:56', '1', ' อัพเดต ', '005', '005'),
(52, '006', '006', '2023-11-07', '09:57', '1', ' อัพเดต ', '006', '006');
...
INSERT INTO `zipcode` (`id`, `district_code`, `zipcode`) VALUES
(1, '100101', '10200'),
(2, '100102', '10200'),
(3, '100103', '10200'),
(4, '100104', '10200'),
...
--
-- Indexes for table `codenumber`
--
ALTER TABLE `codenumber`
  ADD PRIMARY KEY (`pk`);
...
--
-- Indexes for table `drophight`
--
ALTER TABLE `drophight`
  ADD PRIMARY KEY (`pk`);

--
-- Indexes for table `drop_statusproduct`
--
ALTER TABLE `drop_statusproduct`
  ADD PRIMARY KEY (`pk`);

--
-- Indexes for table `drop_statusproduct2`
--
ALTER TABLE `drop_statusproduct2`
  ADD PRIMARY KEY (`pk`);
...
--
-- Indexes for table `list_order_fav`
--
ALTER TABLE `list_order_fav`
  ADD PRIMARY KEY (`pk`);
...
--
-- Indexes for table `product_list_pre`
--
ALTER TABLE `product_list_pre`
  ADD PRIMARY KEY (`pk`);

--
-- Indexes for table `product_pre`
--
ALTER TABLE `product_pre`
  ADD PRIMARY KEY (`pk`);
...
--
-- Indexes for table `run_billcomeback`
--
ALTER TABLE `run_billcomeback`
  ADD PRIMARY KEY (`pk`);

--
-- Indexes for table `run_billcomebackpre`
--
ALTER TABLE `run_billcomebackpre`
  ADD PRIMARY KEY (`pk`);

--
-- Indexes for table `run_bill_pre`
--
ALTER TABLE `run_bill_pre`
  ADD PRIMARY KEY (`pk`);
...
--
-- Indexes for table `run_productpre`
--
ALTER TABLE `run_productpre`
  ADD PRIMARY KEY (`pk`);

--
-- Indexes for table `typecolor`
--
ALTER TABLE `typecolor`
  ADD PRIMARY KEY (`pk`);
...
--
-- Indexes for table `typesend`
--
ALTER TABLE `typesend`
  ADD PRIMARY KEY (`pk`);

--
-- Indexes for table `typesize`
--
ALTER TABLE `typesize`
  ADD PRIMARY KEY (`pk`);

--
-- Indexes for table `update_real_time`
--
ALTER TABLE `update_real_time`
  ADD PRIMARY KEY (`pk`);
...
--
-- AUTO_INCREMENT for table `bank2`
--
ALTER TABLE `bank2`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `codenumber`
--
ALTER TABLE `codenumber`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
-- AUTO_INCREMENT for table `drophight`
--
ALTER TABLE `drophight`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `drop_statusproduct`
--
ALTER TABLE `drop_statusproduct`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `drop_statusproduct2`
--
ALTER TABLE `drop_statusproduct2`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT for table `list_order_fav`
--
ALTER TABLE `list_order_fav`
...
ALTER TABLE `product_list`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `product_list_pre`
--
ALTER TABLE `product_list_pre`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `product_pre`
--
ALTER TABLE `product_pre`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
ALTER TABLE `run_bill`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `run_billcomeback`
--
ALTER TABLE `run_billcomeback`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `run_billcomebackpre`
--
ALTER TABLE `run_billcomebackpre`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `run_bill_pre`
--
ALTER TABLE `run_bill_pre`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
-- AUTO_INCREMENT for table `run_productpre`
--
ALTER TABLE `run_productpre`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `typecolor`
--
ALTER TABLE `typecolor`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
ALTER TABLE `typeproduct`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `typesend`
--
ALTER TABLE `typesend`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `typesize`
--
ALTER TABLE `typesize`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `update_real_time`
--
ALTER TABLE `update_real_time`
  MODIFY `pk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
