       ...
       <!-- page content -->
        	<div class="right_col" role="main" style="background-color: #F5F5F7; " >
             ...
             <div style="margin-top: 1px;" > 
                     <font size="4px" color="#FF6633" class="serif">  รายการคืนสินค้าพรีออเดอร์    </font>  
                     <br> 
                     <font size="2px" color="#767676" class="serif">  หน้าเเรก > รายการคืนสินค้าพรีออเดอร์    </font>   
                     <div > &nbsp; </div>
             </div> 
             </font> 
             </div>
              ...
              <div class=" col-lg-12 "  style="margin-top: -15px;"  > 
                <div class="x_panel"  style="background-color: #FFFFFF;  border-radius: 10px; " > 
                  ...
                  <div style="margin-top: 6px;" > 
                     <font size="4px" color="#000000" class="serif">  รายการคืนสินค้าพรีออเดอร์    </font>   
                  </div> 
                  </font> 
                  </div>
                      ...
                      <?php if(empty($_GET["page"])){ ?>
	   				   ...
	   				   <div class="col-md-12" style="margin-top: 15px;" > 
							  <style>
								...
								<ul class="pagination">
										<?php if ($page > 1): ?>
										<li class="prev"><a href="backpreproduct_p.php?page2=<?php echo $page-1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&status=<?php echo $status; ?>">Prev</a></li>
										<?php endif; ?>

										<?php if ($page > 3): ?>
										<li class="start"><a href="backpreproduct_p.php?page2=1&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&status=<?php echo $status; ?>">1</a></li>
										<li class="dots">...</li>
										<?php endif; ?>

										<?php if ($page-2 > 0): ?><li class="page"><a href="backpreproduct_p.php?page2=<?php echo $page-2 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&status=<?php echo $status; ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
										<?php if ($page-1 > 0): ?><li class="page"><a href="backpreproduct_p.php?page2=<?php echo $page-1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&status=<?php echo $status; ?>"><?php echo $page-1 ?></a></li><?php endif; ?>

										<li class="currentpage"><a href="backpreproduct_p.php?page2=<?php echo $page ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>"><?php echo $page ?></a></li>

										<?php if ($page+1 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="backpreproduct_p.php?page2=<?php echo $page+1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&status=<?php echo $status; ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
										<?php if ($page+2 < ceil($total_record / $perpage)+1): ?><li class="page"><a href="backpreproduct_p.php?page2=<?php echo $page+2 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&status=<?php echo $status; ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

										<?php if ($page < ceil($total_record / $perpage)-2): ?>
										<li class="dots">...</li>
										<li class="end"><a href="backpreproduct_p.php?page2=<?php echo ceil($total_record / $perpage) ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&status=<?php echo $status; ?>"><?php echo ceil($total_record / $perpage) ?></a></li>
										<?php endif; ?>

										<?php if ($page < ceil($total_record / $perpage)): ?>
										<li class="next"><a href="backpreproduct_p.php?page2=<?php echo $page+1 ?>&searchcustomer=<?php echo $searchname; ?>&searchname2=<?php echo $searchname2; ?>&status=<?php echo $status; ?>">Next</a></li>
										<?php endif; ?>
									</ul>
								<?php endif; ?> 
								</div>   
                  		   ...
                  		   <div class="col-lg-12"  align="left" style="margin-top: 15px; "  >  
								...
								<td class="table-action">
								 <?php if($objResult["pasy_status"] == "อยู่ในระหว่างการตรวจสอบ" ){ ?>
									...
									<select class="form-control " style="background-color: #FF8C00; color: white; font-size: 13px; margin-top: -5px; " id="status_send<?php echo $objResult["pk"]; ?>" name="status_send<?php echo $objResult["pk"]; ?>" onChange="showUser_status<?php echo $objResult["pk"]; ?>(this.value)"  > 
										<option value="อยู่ในระหว่างการตรวจสอบ///<?php echo $objResult["pasy_bill"]; ?>" ><font size="2px" class="serif2"> อยู่ในระหว่างการตรวจสอบ </font> </option> 
										<option value="คืนสินค้าแล้ว/โอนเงินแล้ว///<?php echo $objResult["pasy_bill"]; ?>" ><font size="2px" class="serif2"> คืนสินค้าแล้ว/โอนเงินแล้ว </font>  </option>  
									</select>  
								...
								function 
									showUser_status<?php echo $objResult["pk"]; ?>(str) {
										...
										if(check_status=="อยู่ในระหว่างการตรวจสอบ"){ 
											...
											check_status_save = "อยู่ในระหว่างการตรวจสอบ";
										}else if(check_status=="คืนสินค้าแล้ว/โอนเงินแล้ว"){ 
											document.getElementById("status_send<?php echo $objResult["pk"]; ?>").style.color = "White"; 
											document.getElementById("status_send<?php echo $objResult["pk"]; ?>").style.backgroundColor = "#006400"; 

											check_status_save = "คืนสินค้าแล้ว/โอนเงินแล้ว";   
										} 

										$.ajax({
										type: "POST",
										url: "save_status_pay4.php?status="+check_status_save+"&bill_no="+cut_data[1],
