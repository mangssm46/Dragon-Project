       ...
       <!-- page content -->
        	<div class="right_col" role="main" style="background-color: #F5F5F7; " >
             ...
             <div style="margin-top: 1px;" > 
                     <font size="4px" color="#FF6633" class="serif">  ประเภทสินค้า     </font>  
                     <br> 
                     <font size="2px" color="#767676" class="serif">  หน้าเเรก > ประเภทสินค้า     </font>   
                     <div > &nbsp; </div>
             </div> 
             </font> 
             </div>
              ...
              <div class=" col-lg-12 "  style="margin-top: -15px;"  > 
                <div class="x_panel"  style="background-color: #FFFFFF;  border-radius: 10px; " > 
                  ...
                  <div style="margin-top: 6px;" > 
                     <font size="4px" color="#000000" class="serif">  ประเภทสินค้า     </font>   
                  </div> 
                  </font> 
                  </div>
                      ...
                      <?php if(empty($_GET["page"])){ ?>
                         ...
                         <form role="form" name="frmMain" method="post" action="save_typeproduct.php" enctype="multipart/form-data" onsubmit="return validateForm()" > 
							...
							<?php 
								...
								$sql = "SELECT * FROM typeproduct where name != '' order by pk asc   ";   
							...
							?>					
							  <div class="col-lg-12"  align="left" style="margin-top: 15px; "  >  
								 <div class="col-lg-12 " style="margin-top: 10px; border: 1px solid #E0E0E0; border-radius: 5px; background-color: <?php echo $bg; ?>;  " >
										...
										<a  href="typeproduct.php?CusID=<?php echo $objResult["pk"];?>&page=2"   >
                       ...
                       <?php  
						if(isset($_GET["page"])){
						if( ($_GET["page"]) == "2" ){
						$sql = "SELECT * FROM typeproduct Where  pk = '". $_GET["CusID"] ."' ";  
						...
						?>  
						  <form role="form" name="frmMain" method="post" action="save_typeproduct_update.php" enctype="multipart/form-data" onsubmit="return validateForm()" > 
