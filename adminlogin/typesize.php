       ...
       <!-- page content -->
        	<div class="right_col" role="main" style="background-color: #F5F5F7; " >
             ...
             <div style="margin-top: 1px;" > 
                     <font size="4px" color="#FF6633" class="serif">  ประเภทไซต์      </font>  
                     <br> 
                     <font size="2px" color="#767676" class="serif">  หน้าเเรก > ประเภทไซต์      </font>   
                     <div > &nbsp; </div>
             </div> 
             </font> 
             </div>
              ...
              <div class=" col-lg-12 "  style="margin-top: -15px;"  > 
                <div class="x_panel"  style="background-color: #FFFFFF;  border-radius: 10px; " > 
                  ...
                  <div style="margin-top: 6px;" > 
                     <font size="4px" color="#000000" class="serif">  ประเภทไซต์      </font>   
                  </div> 
                  </font> 
                  </div>
                      ...
                      <?php if(empty($_GET["page"])){ ?>
                         ...
                         <form role="form" name="frmMain" method="post" action="save_typesize.php" enctype="multipart/form-data" onsubmit="return validateForm()" > 

							  <div class="col-md-4" style=" margin-top:  15px; " > 

							   <div class="col-md-12 "> 
								  <div class="form-group"> 
									 <font class="serif" size="3px" color="black" for="address"> ประเภทไซต์  </font>
							...
							<div class="col-md-12" >  <hr style=" border: 1px solid #C9C9C9; "> </div>
                     		...
                     		<?php 
								...
								$sql = "SELECT * FROM typesize where name != '' order by pk asc   ";   
							...
							?>					
							  <div class="col-lg-12"  align="left" style="margin-top: 15px; "  >  
								 <div class="col-lg-12 " style="margin-top: 10px; border: 1px solid #E0E0E0; border-radius: 5px; background-color: <?php echo $bg; ?>;  " >
										...
										<a  href="typesize.php?CusID=<?php echo $objResult["pk"];?>&page=2"   >
                       ...
                       <?php  
						if(isset($_GET["page"])){
						if( ($_GET["page"]) == "2" ){
						$sql = "SELECT * FROM typesize Where  pk = '". $_GET["CusID"] ."' ";  
						...
						?>  
						  <form role="form" name="frmMain" method="post" action="save_typesize_update.php" enctype="multipart/form-data" onsubmit="return validateForm()" > 
