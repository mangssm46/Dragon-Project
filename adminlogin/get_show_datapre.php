...
include('../database.php');
	...
	$i = 1; 
	$sql = "  
	SELECT *  FROM product_list_pre  
	where bill_no = ''  and create_by = '".$_SESSION["UserID"]."'
	order by  pk asc "; 
...
?>  
		...
		<div class="row">
			<div class="col-lg-2">  
				...
				function readURL<?php echo $objResult["pk"]; ?>(input) { 
				 ...
				 <input type="file" name="uploadG<?php echo $objResult["pk"]; ?>" id="uploadG<?php echo $objResult["pk"]; ?>" style="display:none;" onchange="readURL<?php echo $objResult["pk"]; ?>(this);"  />
				 <script>
